...
wget -N -6 https://cdn.jsdelivr.net/gh/16188/EUserv-warp/wgcf
...
function upcore(){
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/16188/CFWarp-Pro/upcore.sh&& chmod +x upcore.sh && ./upcore.sh
}
...
function up4(){
wget -N --no-check-certificate https://raw.githubusercontent.com/16188/CFWarp-Pro/main/multi.sh && chmod +x multi.sh && ./multi.sh
}

function up6(){
echo -e nameserver 2a00:1098:2c::1 > /etc/resolv.conf
wget -6 -N --no-check-certificate https://raw.githubusercontent.com/16188/CFWarp-Pro/main/multi.sh && chmod +x multi.sh && ./multi.sh
}

#主菜单
function start_menu(){
    clear
    yellow " 详细说明 https://github.com/16188/CFWarp-Pro  YouTube频道：甬哥侃侃侃" 
...
apt update
apt -y --no-install-recommends install openresolv dnsutils wireguard-tools
wget -N https://github.com/16188/CFWarp-Pro/raw/main/wgcf
cp wgcf /usr/local/bin/wgcf
chmod +x /usr/local/bin/wgcf
echo | wgcf register
until [ $? -eq 0 ]
...
apt update
apt -y --no-install-recommends install openresolv dnsutils wireguard-tools
wget -N -6 https://cdn.jsdelivr.net/gh/16188/CFWarp-Pro/wgcf
cp wgcf /usr/local/bin/wgcf
sudo chmod +x /usr/local/bin/wgcf
echo | wgcf register
until [ $? -eq 0 ]
